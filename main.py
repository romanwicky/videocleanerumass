...
def convertVideoToImages():
    ...
    cap = cv2.VideoCapture('C:/Users/Roman/Desktop/videos/trial7.avi')
...
def makeVideo():
    ...
    # Here, assuming that the program won't exceed 999,999 total frames
    for filename in glob.glob('C:/Users/Roman/Desktop/videos/frames/frame?.jpg'):
    ...
    output = cv2.VideoWriter('C:/Users/Roman/Desktop/videos/trial7trimmed.avi', cv2.VideoWriter_fourcc(*'DIVX'), 29.97,
                             size)
    ...
    output.release()
    shutil.rmtree('C:/Users/Roman/Desktop/videos/frames', ignore_errors=False, onerror=None)
